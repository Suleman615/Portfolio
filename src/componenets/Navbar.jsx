    ...
    return (
        <>
            ...
            <div className={`flex pb-4 flex-col w-full  fixed bg-white dark:bg-gray-950 gap-4 px-6 v ${(shownav) ? 'block md:hidden' : 'hidden'}`}>
                ...
                <div className="cursor-pointer w-fit flex justify-between  gap-10" onClick={() => { switchTheme(), setNav(!shownav) }}><p>Switch Theme</p>{(theme === 'light') ? <BsMoonStars size={24} /> : <MdOutlineLightMode size={24} />}</div>
