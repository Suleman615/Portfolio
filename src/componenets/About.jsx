            ...
            <div className="flex flex-col  sm:flex-row items-center sm:items-start justify-start   gap-2 px-2 md:px-10 lg:px-20 my-10">
                ...
                <div className='flex-grow-[2] px-2 mx-auto max-w-[600px]  flex flex-col gap-4 justify-start mt-4 sm:-mt-10 '>
                    ...
                    <p className=' text-gray-600  text-justify dark:text-gray-200'> 
                        I'm a passionate Developer who specializes in Full Stack development (MERN). I am very enthusiastic about bringing the technical and visual aspects of digital products to life. User experience, pixel perfect design, and writing clear, readable, highly performant code matters to me.<br/><br/>
                        I began my journey as a web developer in 2021, and since then, I've continued to grow and evolve as a developer, taking on new challenges and learning the latest technologies along the way. Now, after 3 years after starting my web development journey, I'm building cutting-edge web applications using modern technologies such as Nodejs, expressjs, Next.js, TypeScript, React.js, Tailwindcss and much more.<br/><br/>
